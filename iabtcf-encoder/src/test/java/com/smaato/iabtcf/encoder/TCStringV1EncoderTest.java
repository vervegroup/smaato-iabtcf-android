...
import static com.smaato.iabtcf.encoder.utils.IntIterableMatcher.matchInts;
import static org.junit.Assert.assertEquals;
import static org.junit.Assert.assertFalse;
import static org.junit.Assert.assertTrue;

import com.smaato.iabtcf.decoder.TCString;
import com.smaato.iabtcf.encoder.utils.TestUtils;
...
public class TCStringV1EncoderTest {
    ...
    public void testCanEncodeV1String() {
        ...
        Assert.assertEquals(TestUtils.toDeci(CREATED), decodedTCString.getCreated());
        Assert.assertEquals(TestUtils.toDeci(UPDATED), decodedTCString.getLastUpdated());
