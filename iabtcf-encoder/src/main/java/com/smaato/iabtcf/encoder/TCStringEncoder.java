package com.smaato.iabtcf.encoder;
    ...
    static class TCStringEncoderV2 implements TCStringEncoder {
        ...
        private TCStringEncoderV2(TCStringEncoder.Builder builder)
            ...
            specialFeatureOptIns =
                    Bounds.checkBoundsBits(builder.specialFeatureOptIns, FieldDefs.CORE_SPECIAL_FEATURE_OPT_INS).build();
            purposesLITransparency =
                    Bounds.checkBoundsBits(builder.purposesLITransparency, FieldDefs.CORE_PURPOSES_LI_TRANSPARENCY).build();
            purposeOneTreatment = builder.purposeOneTreatment;
            publisherCC = Objects.requireNonNull(builder.publisherCC);
            vendorLegitimateInterest =
                    Bounds.checkBounds(builder.vendorLegitimateInterest, FieldDefs.CORE_VENDOR_MAX_VENDOR_ID).build();
            disclosedVendors = Bounds.checkBounds(builder.disclosedVendors, FieldDefs.CORE_VENDOR_MAX_VENDOR_ID).build();
            ...
            publisherRestrictions = Bounds.checkBounds(new ArrayList<>(builder.publisherRestrictions));
        }
